...
public class SuccessfulLoginAwaitingValidation {
    ...
    public void mainActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editTextEmail),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("JakeDove@outlook.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editTextPassword), withText("Password1!"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
